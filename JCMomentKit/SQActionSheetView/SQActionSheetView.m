...
- (id)initWithTitle:(NSString *)title
        ...
        buttonClick:(void(^)(SQActionSheetView *sheetView,NSInteger buttonIndex))block{
    ...
    if (self = [super init]) {
        ...
        [buttons enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            [button setTitleColor:colors[idx] forState:UIControlStateNormal];
            [button setTitleColor:colors[idx] forState:UIControlStateHighlighted];
            [button setBackgroundImage:[self imageWithColor:[[UIColor whiteColor] colorWithAlphaComponent:0.8] frame:CGRectMake(0, 0, CGRectGetWidth(self.frame), ButtonHeight)] forState:UIControlStateNormal];
            [button setBackgroundImage:[self imageWithColor:[[UIColor blackColor] colorWithAlphaComponent:0.2] frame:CGRectMake(0, 0, CGRectGetWidth(self.frame), ButtonHeight)] forState:UIControlStateHighlighted];
