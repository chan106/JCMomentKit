...
- (void)dismissAnimated:(BOOL)animated completion:(void (^)(void))completion {
    ...
    [[UIApplication sharedApplication] setStatusBarHidden:_fromNavigationBarHidden withAnimation:NO];
...
- (void)longPress:(UIGestureRecognizer*)gesture {
    ...
    if(gesture.state==UIGestureRecognizerStateBegan){
        ...
        YYPhotoGroupCell *tile = [self cellForPage:self.currentPage];
        UIImageView*tempImageView = tile.imageView;
...
- (void)saveImageToAlbum{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
            //写入图片到相册
            YYPhotoGroupCell *tile = [weakSelf cellForPage:weakSelf.currentPage];
